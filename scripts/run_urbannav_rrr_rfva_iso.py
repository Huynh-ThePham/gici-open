...
if __name__ == "__main__":
    raise SystemExit(
        runner.main(
            ...
            template_path=runner.REPO / "research" / "config" / "rtk_imu_camera_rrr_rfva_urbannav_iso.yaml",
            expected_estimator="rtk_imu_camera_rrr_va",
            result_algorithm="rtk_imu_camera_rrr_rfva_iso",
            default_out_root=Path(runner.REPO) / "results" / "research" / "urbannav_rfva_iso",
        )
    )
